/**
 * Clase de comando CQRS que representa la operación CreateMercanciaPeligrosaCommand.
 * Encapsula los datos necesarios para ejecutar el caso de uso.
 */
export class CreateMercanciaPeligrosaCommand {
  /**
     * Constructor del comando CreateMercanciaPeligrosaCommand.
